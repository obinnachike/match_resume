...
def llm_pipeline(file_path, job_text):
    ...
    # ✅ Using SequentialChain with multiple output keys
    ...
    # ✅ Correctly calling the chain (multiple output keys)
    results = []
    for i, resume_chunk in enumerate(document_chunks):
        for j, job_chunk in enumerate(job_chunks):
            ...
            results.append((
                ...
                output  # ← This is a dict with 'resume_summary' and 'comparison_result'
            ))
